...
const Home = () => {
            ...
            <div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-10"> 
                    <div className="border-r-2 pr-2">
                        <h3 data-aos="fade-down" className="text-2xl pb-2">ALL KIND OF LOGISTICS AND RESOURCES SUPPORT</h3>
                        <p data-aos="fade-right" className="pb-5">As an experienced Event Management company, we have all kind of Event equipment, logistics and resources available for your cultural celebrations programing </p>
                        <img data-aos="fade-down" className="pr-2" src={`https://i.ibb.co/cygLzJW/almonte-celtfest-scaled.jpg`} alt="" />
                    </div>
                    <div>
                    <img data-aos="fade-down-left" src={`https://i.ibb.co/J3GdW3F/1.jpg`} alt="" />
                        <h3 className="text-2xl pb-2 pt-5">EXPERIENCED EVENT PLANNER AND MANAGER</h3>
                        <p  data-aos="fade-down-right">When it is about making your Event successful, it is all about making a good plan, managing and executing successfully. And, we have experienced who will make your event unique and memorable!</p>
                    </div>
                </div>
            </div>
            <div> 
                <h1 data-aos="zoom-in" className="text-5xl text-center py-10 text-rose-600 font-bold">Our Services</h1>
                <p data-aos="zoom-in-down" className="text-center px-10 pb-5">At Cultural Calibration, we offer a comprehensive range of services to meet all your event planning and management needs. Whether you are organizing a corporate conference, a wedding, a cultural celebration, or any other type of event, our experienced team is here to make it a seamless and memorable experience. Here are the services we provide:</p>
            </div>
  ...
  <div className="hero-content text-center">
    <div className="max-w-md">
      ...
      <h1 data-aos="zoom-out-left" className="text-4xl font-bold text-rose-600">Book Our service Today!</h1>
      <p className="py-6">Our attractive, space invites your guests to be a part of a heavily invested event.</p>
      <button data-aos="fade-down-left" className="py-4 px-6 rounded-xl  bg-rose-600 hover:bg-rose-400 text-xl text-white font-semibold ">Get Booking</button>
