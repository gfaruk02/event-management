...
const Footer = () => {
    return (
        <div>
            <footer className="footer p-10 text-white bg-rose-500 text-base-content">
                <nav>
            ...
            <footer className="footer px-10 py-4 border-t text-white bg-rose-900 text-base-content border-rose-300">
                <aside className="items-center grid-flow-col">
                    ...
                    <p>Cultural Celebration. <br />Providing reliable event since 2020</p>
                </aside>
